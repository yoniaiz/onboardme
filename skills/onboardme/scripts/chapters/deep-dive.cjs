  ...
  phases: [
    {
      ...
      tips: "For bootup errors: react in character ('MODULE_NOT_FOUND... did you forget something?'). For trace: read the entry point files yourself first. If player can't run the project at all (env issues), pivot to code exploration — read the code to understand what it WOULD do.",
    },
    {
      id: "entities",
      instruction:
